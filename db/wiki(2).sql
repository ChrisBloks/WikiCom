...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 15, 2026 at 03:20 PM
...
(1, '', 'POST', 'Send message', 3, 'form-control', '', 'btn btn-primary btn-sm'),
(2, '', 'POST', 'Log in', 4, 'form-control', '', 'btn btn-primary btn-sm'),
(3, '', 'POST', 'Filter', 6, 'form-control justify-content-start', '', 'btn btn-primary btn-sm'),
(4, '', 'POST', 'SaveArticle\r\n', 7, 'form-control', 'multipart/form-data', 'btn btn-primary btn-sm'),
(5, '', 'POST', 'Save About', 2, 'form-control', 'multipart/form-data', 'btn btn-primary btn-sm'),
(6, '', 'GET', 'Create new article', 8, 'form-group', '', 'btn btn-primary btn-sm'),
(7, '', 'POST', 'Register', 5, 'form-control', '', 'btn btn-primary btn-sm'),
(9, '', 'POST', 'Change information', 10, 'form-control mt-5', 'multipart/form-data', 'btn btn-primary'),
...
(11, 'Marius', '$2y$10$M2A9UyZxjKNLJ2YSVeUA2.E21G6yuexpBqQgPdpBng3kGvzsZBog6', 'marius@email.com', 'author_11.png', 'So true bestie');
